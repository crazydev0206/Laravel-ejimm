...
class ProductCreateWithCsv extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'products:create:with:csv';
    ...
    {
        Log::info('Showing productCreate');

        $productsFile = public_path('csv-products/product.csv');
