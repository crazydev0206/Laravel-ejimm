            ...
            <div class="container">
               ...
               <?php
	            $uri = $_SERVER['REQUEST_URI'];
	  			if($uri=='/categories/baby-doll-zubehor/products' ){
					?>
                              <h1>Puppen-Doppelkinderwagen</h1>
                  <b>Wichtigkeit, Puppen-Doppelkinderwagen zu haben.</b>
                  <p>Haben Sie ein kleines Mädchen, vielleicht eine jüngere Tochter? Dann haben Sie evtl. Puppen, Kinderwagen und Puppen-Doppelkinderwagen. Jüngere Kinder, hauptsächlich kleine Frauen, lieben es, ihre Mütter nachzuahmen und mit ihren Puppen durch den Park, die Straße hinunter über den Rasen und viele andere zu schlendern. Puppen-Doppelkinderwagen & Kinderwagen ermöglichen es Kindern, ihre Babys/Puppen in ihren Kinderwagen zu schieben, ähnlich wie Mama und Papa sie in jüngeren Jahren oder ihre Geschwister geschoben haben. Ejim stellt zahlreiche wundervolle, hochwertige Puppen-Doppelkinderwagen und Kinderwagen her, mit denen Kinder spielen können, die Sie wirklich lieben werden. Kinder profitieren erheblich vom interaktiven Spiel, das die Verpflichtungen eines Elternteils widerspiegelt. Diese Spielform ermöglicht Ihrem Kind, seine Kreativität zu erforschen, Pflichtkonzepte zu testen und sich mit anderen auseinanderzusetzen. Eine Möglichkeit, dies zu verschönern, besteht darin, Ihrem Kleinkind einen Puppenwagen anzubieten.</p>
                    <?php
                }
				else {
					?>
